<template>
  <v-container fluid grid-list-xl>
    <app-breadcrumbs :items="breadcrumbItems" icon="person_add" title="Editar Usuário"></app-breadcrumbs>
...
<<<<<<< HEAD:proficiencia/front-end/src/views/coordenador/usuario/EditarUsuarioForm.vue
...
>>>>>>> c426de99b2dd0abab857d9955af6764fb71e8ada:proficiencia/front-end/src/views/gestor/usuario/EditarUsuarioForm.vue
          </v-form>
        </div>
...
export default {
  ...
  created() {
    axios.get("/usuario/" + this.id).then(response => {
